...
export function ArticlesInlineAdCarousel() {
  const [activeIndex, setActiveIndex] = useState(0);
  const placementsQuery = useQuery({
    queryKey: ["service-placements", "articles", "inline_ad"],
    queryFn: async () =>
      sortPlacements(
    ...
    <section className="border-y border-brand-saffron-100 bg-[#fff8f2]">
      <div className="mx-auto max-w-site px-4 py-8 sm:py-10 md:px-8 md:py-12 lg:px-16">
        ...
        <div
          ...
          aria-label={hasMultiple ? "Handpicked puja services" : undefined}
        >

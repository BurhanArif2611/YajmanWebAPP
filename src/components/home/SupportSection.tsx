...
export function SupportSection() {
  return (
    <section className="bg-surface-peach">
      <div className="mx-auto max-w-site px-4 py-10 text-center md:px-8 md:py-12 lg:px-16 lg:py-16">
        <SectionHeader
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-5 sm:mt-8 sm:flex-row sm:gap-16">
